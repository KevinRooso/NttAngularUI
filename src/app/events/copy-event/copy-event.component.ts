...
export class CopyEventComponent implements OnInit {
  ...
  submitChanges() {
    ...
    if (d1.getTime() < this.newtoday.getTime()) {
      this.snackBar.open('Event start date should be Greater than current Date', 'Close', { duration: 2000 });
      return null;
    }
    ...
    if (d1.getTime() < this.newtoday.getTime()) {
      this.snackBar.open('Event end date should be Greater than current Date', 'Close', { duration: 2000 });
      return null;
    }
    ...
    if (d1.getTime() < this.newtoday.getTime()) {
      this.snackBar.open('Registration start date should be Greater than current Date', 'Close', { duration: 2000 });
      return null;
    }
    ...
    if (d1.getTime() < this.newtoday.getTime()) {
      this.snackBar.open('Registration end date should be Greater than current Date', 'Close', { duration: 2000 });
      return null;
    }
