...
export class HomeUiComponent implements OnInit {
  ...
  getGlobalDataForBanner1() {
    ...
    this.bannerConfigurationForm1.get(['sequenceNumber']).setValue('1');
  ...
  getGlobalDataForBanner2() {
    ...
    this.bannerConfigurationForm2.get(['sequenceNumber']).setValue('2');
  ...
  getGlobalDataForBanner3() {
    ...
    this.bannerConfigurationForm3.get(['sequenceNumber']).setValue('3');
